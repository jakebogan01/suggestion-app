        ...
        <div class="font-jost font-normal max-w-[730px] mx-auto">
            <main>
                <section class="mb-10 max-w-[530px] mx-auto px-4 md:px-0">
                    ...
                    <form on:submit|preventDefault={handleSubmit} enctype="multipart/form-data" class="relative bg-white dark:bg-[#222222] hover:shadow-lg p-6 rounded-[0.625rem] mt-12 md:mt-16">
                        ...
                        <div class="mt-6 md:mt-8">
                            ...
                            <div class="mt-6 md:mt-16 space-y-6">
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <input type="text" on:input={(e) => (formValues.title = e.target.value)} bind:value={formValues.title} name="title" id="title" spellcheck="true" class="block w-full bg-[#F7F8FE] dark:bg-white/20 text-13 md:text-15 text-[#3A4374] dark:text-white p-3 rounded-[0.3125rem] border-0 ring-1 placeholder:text-[#3A4374] dark:placeholder:text-white/40 ring-inset dark:ring-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600 {emptyFields.includes('title') ? 'border border-red-500' : ''}" required>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <select on:change={(e) => (formValues.tag = e.target.value)} id="tag" name="tag" class="block w-full bg-[#F7F8FE] dark:bg-white/20 text-13 md:text-15 text-[#3A4374] dark:text-white p-3 rounded-[0.3125rem] border-0 ring-1 placeholder:text-[#3A4374] dark:placeholder:text-white/40 ring-inset dark:ring-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600">
                        ...
                        <div class="flex flex-col md:flex-row md:justify-end items-center md:space-x-4 space-y-4 md:space-y-0 mt-10 mb-8">
                            ...
                            <button type="submit" class="inline-flex w-full justify-center items-center rounded-[0.625rem] bg-[#238AB6] hover:bg-[#186489] px-3 h-10 md:w-[9rem] text-[#F2F4FE] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:col-start-2">Add feedback</button>
                        </div>
                    </form>
                </section>
            </main>
